...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$productimage1_tmp = $_FILES["productimage1"]["tmp_name"];

		$productimage2 = $_FILES["productimage2"]["name"];
		$productimage2_tmp = $_FILES["productimage2"]["tmp_name"];
		
		$productimage3 = $_FILES["productimage3"]["name"];
		$productimage3_tmp = $_FILES["productimage3"]["tmp_name"];
		...
		move_uploaded_file($productimage1_tmp,"productimages/$productid/".$productimage1);
		move_uploaded_file($productimage2_tmp,"productimages/$productid/".$productimage2);
		move_uploaded_file($productimage3_tmp,"productimages/$productid/".$productimage3);
